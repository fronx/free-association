...
1. **One's Recognition** is one's acknowledgment of *contributions towards one's own self-actualization*.
...
* The diversity of available contributions increases dramatically
...
* Surplus flows efficiently to where it contributes to real self-actualization
